...
class _OtherProfilePageState extends State<OtherProfilePage> {
  ...
  void  _apiLoadUser() {
    ...
    DBService.loadUser(widget.uid).then((value) => {_resLoadUser(value)});
  }

  void _resLoadUser(Member userModel) {
    setState(() {
      fullName = userModel.fullname;
      email = userModel.email;
      img_url = userModel.img_url;
      followers = userModel.followers_count;
      following = userModel.following_count;
      _apiLoadPost();
    });
  }
  ...
  void  _apiLoadPost() {
    ...
    DBService.loadOtherfPosts(widget.uid).then((value) => {_resLoadPosts(value)});
  }
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ClipRRect(
                        ...
                        child: img_url == ""
                            ? Image.asset(
                          "assets/images/avatar-3814081_1280.png",
                          width: 70,
                          height: 70,
                        )
                            : CachedNetworkImage(
